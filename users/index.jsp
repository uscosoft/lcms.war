...
%>	
    ...
    <!-- page specific -->
	<script type="text/javascript" src="forma-cursoestudiante.js"></script>
    <script type="text/javascript" src="grid-cursoestudiante.js"></script>
    
</head>
<body>
	<h1 align="center"><font face = "verdana" color = "dark">CURSOS A LOS CUALES ESTA INSCRITO</font></h1>
    <br/>
    <br/>
