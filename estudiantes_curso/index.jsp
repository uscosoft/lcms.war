...
%>	
    ...
    <!-- page specific -->
	<script type="text/javascript" src="forma-estudiante_curso.js"></script>
    <script type="text/javascript" src="grid-estudiante_curso.js"></script>
    
</head>
<body>
	<h1 align="center"><font face = "verdana" color = "dark">ESTUDIANTES POR CURSOS</font></h1>
    <br/>
    <br/>
