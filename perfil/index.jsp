...
%>	
    ...
    <!-- page specific -->
	<script type="text/javascript" src="forma-perfil.js"></script>
    <script type="text/javascript" src="grid-perfil.js"></script>
    
</head>
<body>
	<h1 align="center"><font face = "verdana" color = "dark">ASIGNACION DE PERFILES A USUARIOS DEL SISTEMA</font></h1>
    <br/>
    <br/>
