...
%>
    ...
    <!-- page specific -->
	<script type="text/javascript" src="forma-curso.js"></script>
    <script type="text/javascript" src="grid-curso.js"></script>
	
</head>
<body>
    <h1 align="center"><font face = "verdana" color = "dark">AGREGAR CURSOS</font></h1>
    <br/>
    <br/>
